...
| CSP is still in Report-Only mode; `flagcdn.com` not yet allowlisted | Medium | Tracked in `docs/security/csp/CSP_NOTES.md` §4 — resolve the known `img-src` gap and let Report-Only run over a real traffic window before enforcing. |
